...
1. 사용자가 보유한 문서를 AI가 이해할 수 있는 형태로 변환
2. 문서 내용을 기반으로 사용자의 질문에 답변
3. 답변과 함께 근거 문서 조각을 제공하여 신뢰성 확보
4. 워크스페이스 단위로 문서를 관리하여 사용자별, 조직별 문서 활용을 가능하게 함
5. 향후 업무 자동화, 사내 지식 검색, 문서 요약, 보고서 생성 등 기능 추가
